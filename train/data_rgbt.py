...
class TrainDataLoaderRGBT(Dataset):
    ...
    def _pick_img_pairs(self, index_of_subclass):
        ...
        assert index_of_subclass < len(self.seq_dataset_rgb), 'index_of_subclass should less than total classes'


        img_files_rgb, anno = self.seq_dataset_rgb[index_of_subclass][:2]
        img_files_ir = self.seq_dataset_i[index_of_subclass][0]
        video_gt = np.loadtxt(self.seq_dataset_rgb.anno_files[index_of_subclass], delimiter=',')
    ...
    def __getitem__(self, index):
        ...
        index = random.choice(range(len(self.seq_dataset_rgb)))
...
if __name__ == "__main__":
    ...
    train_data  = TrainDataLoaderRGBT(seq_dataset_rgb, seq_dataset_i, train_z_transforms, train_x_transforms)
