...
from ..datasets.got10k_test import GOT10k_test
from ..utils.metrics import rect_iou
from ..utils.viz import show_frame
from ..utils.ioutils import compress


class ExperimentGOT10k_test(object):
    ...
    """
    def __init__(self, root_dir1, root_dir_2=None, subset='val', list_file=None,
                 result_dir='results', report_dir='reports'):
        super(ExperimentGOT10k_test, self).__init__()
        assert subset in ['val', 'test']
        self.subset = subset
        self.dataset = GOT10k_test(
