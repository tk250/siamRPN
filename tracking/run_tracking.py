...
parser.add_argument('--net_path', default='../train/experiments/late_fusion/model/model_e50.pth', metavar='DIR',help='path to weight')
...
if __name__ == '__main__':
    ...
    experiments = ExperimentOTB('/home/krautsct/RGB-t-Val', version='test',
                    result_dir='experiments/{}/late_fusion'.format(args.experiment_name),
                    report_dir='experiments/{}/late_fusion_report'.format(args.experiment_name))
